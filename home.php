	...
	<div class="page-wrapper">
		...
		<div class="page-content">
					...
					<ul class="header-actions">
						...
						<li class="dropdown">
							<a href="#" id="notifications" data-toggle="dropdown" aria-haspopup="true">
								<i class="icon-bell"></i>
								<span
									class="count-label"><?php //echo count($notification); // count($notificationmax); 
														?></span>
							</a>
			...
			if ($current_page == 'bank_creation') {
				include "include/templates/bank_creation.php";
			}

			if ($current_page == 'edit_bank_creation') {
				include "include/templates/edit_bank_creation.php";
			}
			...
			if ($current_page == 'bank_fees_report') {
				include "reports/fees_details_report/bank_fees_report.php";
			}
