...
<table class="table table-bordered" id="show_student_fees_summary_list">
    <thead>
        <tr>
            <th colspan='14'>Fees Summary Report From <?php echo $feesFromDate->format('d-m-Y'); ?> To <?php echo $feesToDate->format('d-m-Y'); ?> </th>
        </tr>
        <tr>
    ...
    <tbody>
       ...
       COALESCE( SUM(CASE WHEN acp.particulars LIKE '%III%' THEN tafd.fee_received ELSE 0 END),0) AS transport_fee_t3,
       SUM(
                CASE 
            ...
            ON taf.id = tafd_deno.admission_fees_ref_id JOIN area_creation_particulars acp 
