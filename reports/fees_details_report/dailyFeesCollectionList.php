...
<table class="table table-bordered" id="show_student_fees_summary_list">
    ...
    FROM (
        ...
        SELECT
            ...
            0,
            SUM(CASE WHEN tafd_deno.payment_mode = 'cash_payment' THEN tafd.fee_received ELSE 0 END),
            SUM(CASE WHEN tafd_deno.payment_mode != 'cash_payment' THEN tafd.fee_received ELSE 0 END)
        ...
        SELECT
            ...
            SUM(CASE WHEN lyfd_deno.payment_mode = 'cash_payment' THEN lyfd.fee_received ELSE 0 END),
            SUM(CASE WHEN lyfd_deno.payment_mode != 'cash_payment' THEN lyfd.fee_received ELSE 0 END)
